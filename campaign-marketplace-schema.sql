-- Campaign Marketplace Schema for Mission Control
...
CREATE INDEX idx_campaign_purchases_user ON campaign_purchases(user_id);
CREATE INDEX idx_campaign_purchases_org ON campaign_purchases(organization_id);
CREATE INDEX idx_generated_emails_purchase ON generated_emails(purchase_id);
...
(
  ...
  'Dear {name}, Welcome to {practice_name}! We''re thrilled to have you as our newest patient and look forward to partnering with you on your health journey...'
),
(
  ...
  'Hi {name}, Just a friendly reminder about your appointment tomorrow at {time} with Dr. {doctor}. We''re looking forward to seeing you!...'
),
(
  ...
  'Dear {name}, We noticed it''s been a while since your last visit, and we wanted to check in. Your health is important to us...'
),
(
...
(
  ...
  'Dear Dr. {recipient_name}, I hope this email finds you well. I''m reaching out to introduce myself and explore potential collaboration...'
);