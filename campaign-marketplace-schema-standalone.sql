-- Campaign Marketplace Schema for Mission Control (Standalone Version)
...
CREATE TABLE IF NOT EXISTS campaign_purchases (
  ...
  organization_id UUID REFERENCES organizations(id) ON DELETE SET NULL, -- Made optional
...
-- Create some initial metrics for the campaigns
